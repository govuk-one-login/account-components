...
- `npm run detect-secrets` to detect secrets which should not be in the repo. False positives can be ignored by recreating the baseline file by running `npm run detect-secrets:recreate`.
