...
- In GitHub create a personal access token which has `read:packages` permission and in the configuration file for your shell export a variable called `GITHUB_NPM_TOKEN` with the value of the personal access token
