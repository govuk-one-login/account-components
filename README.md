...
- ensure the major version of `@types/node` installed as a development dependency in `package.json` and and `solutions/integration-tests/package.json` corresponds with the Node version being used
